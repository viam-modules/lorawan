...
func (g *NetworkServer) setupSqlite(ctx context.Context, pathPrefix string) error {
...
func (g *NetworkServer) insertOrUpdateDeviceInDB(ctx context.Context, device deviceInfo) error {
	if g.db == nil {
		return errNoDB
	}
...
func (g *NetworkServer) findDeviceInDB(ctx context.Context, devEui string) (deviceInfo, error) {
	if g.db == nil {
...
func (g *NetworkServer) getAllDevicesFromDB(ctx context.Context) ([]deviceInfo, error) {
	if g.db == nil {
		return nil, errNoDB
	}
...
func (g *NetworkServer) migrateDevicesFromJSONFile(ctx context.Context, pathPrefix string) error {
